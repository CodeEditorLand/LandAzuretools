...
export async function getWebLocations(
	...
	return (<GeoRegionJsonResponse>result.parsedBody).value.map(
		(l: GeoRegion) => nonNullProp(l, "name")
	);
}
