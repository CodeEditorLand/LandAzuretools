...
const unsupportedError: Error = new Error(
	l10n.t("This operation is not supported.")
);

export abstract class AzExtTreeFileSystem<
	TItem extends types.AzExtTreeFileSystemItem,
