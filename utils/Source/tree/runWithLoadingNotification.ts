...
export async function runWithLoadingNotification<T>(
	...
	return await window.withProgress(
		...
		async (progress, cancellationToken) => {
			const message: string =
				context.loadingMessage || l10n.t("Loading resources...");

			const messageDelay: number =
				context.loadingMessageDelay !== undefined
					? context.loadingMessageDelay
					: 2;
