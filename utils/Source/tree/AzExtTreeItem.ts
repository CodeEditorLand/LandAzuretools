...
export abstract class AzExtTreeItem implements types.AzExtTreeItem {
	...
	public get collapsibleState(): TreeItemCollapsibleState | undefined {
		...
		if (
			...
			return this.treeDataProvider.collapsibleStateTracker.getCollapsibleState(
				this,
			);
		}
	...
	public get effectiveIconPath(): types.TreeItemIconPath | undefined {
		return this._temporaryDescription || this.isLoadingMore
	...
	public get treeDataProvider(): IAzExtTreeDataProviderInternal {
		return (
			...
			nonNullProp(this, "parent").treeDataProvider
		);
	}
	...
	public get tooltip(): string | undefined {
		if (
			process.env.DEBUGTELEMETRY === "v" &&
			!!settingUtils.getWorkspaceSetting<unknown>(showContextValueSetting)
		) {
