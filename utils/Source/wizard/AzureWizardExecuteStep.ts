...
export abstract class AzureWizardExecuteStep<
	T extends types.IActionContext & Partial<types.ExecuteActivityContext>,
> implements types.AzureWizardExecuteStep<T>
{
	public id?: string;
