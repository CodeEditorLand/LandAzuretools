...
export abstract class AzureWizardPromptStep<T extends types.IActionContext>
	implements types.AzureWizardPromptStep<T>
{
	...
	public getSubWizard?(
		wizardContext: T,
	): Promise<types.IWizardOptions<T> | undefined>;
