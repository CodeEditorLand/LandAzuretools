...
import {
	...
	AzExtOpenDialogOptions,
	AzExtWorkspaceFolderPickOptions,
	AzureUserInputQueue,
	IAzureMessageOptions,
	IAzureQuickPickItem,
	IAzureQuickPickOptions,
	IAzureUserInput,
	PromptResult,
	type AzExtUserInputWithInputQueue as AzExtUserInputWithInputQueueType,
} from "../../";
import { UserCancelledError } from "../errors";
import { addStepTelemetry, AzExtUserInput } from "./AzExtUserInput";
import { IInternalActionContext } from "./IInternalActionContext";

export class AzExtUserInputWithInputQueue
	implements AzExtUserInputWithInputQueueType
{
	...
	public async showQuickPick<TPick extends IAzureQuickPickItem<unknown>>(
		items: TPick[] | Promise<TPick[]>,
	...
	public async showOpenDialog(
		options: AzExtOpenDialogOptions,
	): Promise<vscode.Uri[]> {
		addStepTelemetry(
			this._context,
			options.stepName,
