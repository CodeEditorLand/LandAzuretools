...
export interface AzureHostExtensionApi {
	 ...
	 */
	pickAppResource<T extends AzExtTreeItem>(
 ...
 */
export type ResolvedAppResourceBase = Partial<{
	[P in keyof SealedAzExtTreeItem]: never;
}> &
	Partial<AbstractAzExtTreeItem> &
	ContextValuesToAdd;
 ...
 */
export type ResolvedAppResourceTreeItem<T extends ResolvedAppResourceBase> =
	SealedAzExtTreeItem &
		AbstractAzExtTreeItem &
		Omit<T, keyof ResolvedAppResourceBase>;
...
export interface AppResourceResolver {
	...
	): vscode.ProviderResult<ResolvedAppResourceBase>;
...
export interface WorkspaceResourceProvider {
	...
	): vscode.ProviderResult<WorkspaceResource[] | undefined>;
}
...
export interface ActivityTreeItemOptions {
	...
	getChildren?: (
		parent: AzExtParentTreeItem,
	) => AzExtTreeItem[] | Promise<AzExtTreeItem[]>;
}
