...
import {
	...
	TreeView,
	Uri,
	QuickPickOptions as VSCodeQuickPickOptions,
	WorkspaceFolder,
...
import type {
	Activity,
	ActivityTreeItemOptions,
	AppResource,
	OnErrorActivityData,
	OnProgressActivityData,
	OnStartActivityData,
	OnSuccessActivityData,
} from "./hostapi"; // This must remain `import type` or else a circular reference will result
 ...
 */
export declare class AzExtTreeDataProvider
	implements TreeDataProvider<AzExtTreeItem>, Disposable
{
	 ...
	 */
	public constructor(
		rootTreeItem: AzExtParentTreeItem,
		loadMoreCommandId: string,
	);
	 ...
	 */
	public showTreeItemPicker<T extends AzExtTreeItem>(
	 ...
	 * @param context The action context
	 */
	public findTreeItem<T extends AzExtTreeItem>(
		fullId: string,
		context: IFindTreeItemContext,
	): Promise<T | undefined>;
	 ...
	 */
	public trackTreeItemCollapsibleState(
...
export interface SealedAzExtTreeItem {
	...
	runWithTemporaryDescription(
		context: IActionContext,
		options: RunWithTemporaryDescriptionOptions,
		callback: () => Promise<void>,
	): Promise<void>;
}
...
export declare abstract class AzExtTreeItem implements IAzExtTreeItem {
	 ...
	 * Displays a 'Loading...' icon and temporarily changes the item's description while `callback` is being run
	 */
	public runWithTemporaryDescription(
		context: IActionContext,
		description: string,
		callback: () => Promise<void>,
	): Promise<void>;
...
export declare function isAzExtTreeItem(
	maybeTreeItem: unknown,
): maybeTreeItem is AzExtTreeItem;
export declare function isAzExtParentTreeItem(
	maybeParentTreeItem: unknown,
): maybeParentTreeItem is AzExtParentTreeItem;
...
export declare class GenericParentTreeItem extends AzExtParentTreeItem {
	...
	constructor(
		parent: AzExtParentTreeItem | undefined,
		options: GenericParentTreeItemOptions,
	);
...
export declare class GenericTreeItem extends AzExtTreeItem {
	...
	constructor(
		parent: AzExtParentTreeItem | undefined,
		options: IGenericTreeItemOptions,
	);
}
...
export declare class InvalidTreeItem extends AzExtParentTreeItem {
	...
	constructor(
		...
		error: unknown,
		options: IInvalidTreeItemOptions,
	);
 ...
 * NOTE: *Impl methods are not meant to be called directly - just implemented.
 */
export declare abstract class AzExtParentTreeItem
	extends AzExtTreeItem
	implements IAzExtParentTreeItem
{
	//#region Properties implemented by base class
	/**
	 ...
	 * @param context The action context
	 */
	public abstract loadMoreChildrenImpl(
		clearCache: boolean,
		context: IActionContext,
	): Promise<AzExtTreeItem[]>;
 ...
 */
export declare function isUserCancelledError(
	error: unknown,
 ...
 */
export declare function registerEvent<T>(
	eventId: string,
	event: Event<T>,
 ...
 * NOTE: If the environment variable `DEBUGTELEMETRY` is set to a non-empty, non-zero value, then telemetry will not be sent. If the value is 'verbose' or 'v', telemetry will be displayed in the console window.
 */
export declare function callWithTelemetryAndErrorHandling<T>(
	callbackId: string,
 ...
 * NOTE: If the environment variable `DEBUGTELEMETRY` is set to a non-empty, non-zero value, then telemetry will not be sent. If the value is 'verbose' or 'v', telemetry will be displayed in the console window.
 */
export declare function callWithTelemetryAndErrorHandlingSync<T>(
	callbackId: string,
	callback: (context: IActionContext) => T,
): T | undefined;

/**
 * Used to mask values in error messages to protect user's confidential information from displaying in output and telemetry
 */
export declare function callWithMaskHandling<T>(
	callback: () => Promise<T>,
	valueToMask: string,
): Promise<T>;
 ...
 */
export declare function addExtensionValueToMask(
 ...
 */
export declare function registerOnActionStartHandler(
	handler: OnActionStartHandler,
): Disposable;
 ...
 * NOTE: If more than one handler is registered, they are run in an arbitrary order.
 */
export declare function registerTelemetryHandler(
...
export interface IAzureUserInput {
	...
	showQuickPick<T extends QuickPickItem>(
		items: T[] | Thenable<T[]>,
		options: IAzureQuickPickOptions & { canPickMany: true },
	): Promise<T[]>;
	...
	showWorkspaceFolderPick(
		options: AzExtWorkspaceFolderPickOptions,
 ...
 */
export interface IAzureQuickPickOptions
	extends VSCodeQuickPickOptions,
		AzExtUserInputOptions {
	/**
 ...
 */
export interface IAzureMessageOptions
 ...
 */
export interface AzExtInputBoxOptions
 ...
 */
export interface AzExtOpenDialogOptions
 ...
 */
export type AzExtWorkspaceFolderPickOptions = WorkspaceFolderPickOptions &
	AzExtUserInputOptions;
 ...
 */
export type AzureUserInputQueue = (
	| QuickPickItem
	| string
	| MessageItem
	| Uri[]
 ...
 */
export declare class AzureWizard<
...
export declare interface ExecuteActivityContext {
	 ...
	 */
	wizardActivity?: new <TContext extends ExecuteActivityContext>(
		context: TContext,
		task: ActivityTask<void>,
	) => ExecuteActivity;
 ...
 */
export declare abstract class AzureNameStep<
 ...
 */
export declare function registerUIExtensionVariables(
 ...
 */
export declare function createExperimentationService(
...
export interface IExperimentationServiceAdapter {
	 ...
	 */
	getCachedTreatmentVariable<T extends string | number | boolean>(
		name: string,
	): Promise<T | undefined>;
	 ...
	 * @param name The variable name
	 */
	getLiveTreatmentVariable<T extends string | number | boolean>(
		name: string,
	): Promise<T | undefined>;
}
 ...
 */
export declare function appendExtensionUserAgent(
	existingUserAgent?: string,
): string;

export type AzureExtensionApiFactory<
	T extends AzureExtensionApi = AzureExtensionApi,
> = {
	apiVersion: string;
 ...
 */
export declare function createApiProvider(
	azExts: (AzureExtensionApiFactory | AzureExtensionApi)[],
 ...
 */
export declare function createAzExtLogOutputChannel(
	name: string,
 ...
 */
export declare function createAzExtOutputChannel(
	name: string,
 ...
 */
export declare function openReadOnlyJson(
 ...
 */
export declare function openReadOnlyContent(
	node: { label: string; fullId: string },
	content: string,
 ...
 * @param fileExtension The file extension
 */
export declare function stashReadOnlyContent(
	node: { label: string; fullId: string },
	content: string,
	fileExtension: string,
): Promise<ReadOnlyContent>;
 ...
 */
export declare abstract class AzExtTreeFileSystem<
	TItem extends AzExtTreeFileSystemItem,
 ...
 */
export declare function nonNullProp<TSource, TKey extends keyof TSource>(
	source: TSource,
	name: TKey,
 ...
 */
export declare function nonNullValue<T>(
	value: T | undefined,
 ...
 */
export declare function nonNullOrEmptyValue(
 ...
 * for the property and will give a compile error if the given name is not a property of the source.
 */
export declare function nonNullValueAndProp<
	TSource,
	TKey extends keyof TSource,
>(source: TSource | undefined, name: TKey): NonNullable<TSource[TKey]>;
 ...
 */
export declare function getAzureExtensionApi<T extends AzureExtensionApi>(
	extensionId: string,
	apiVersionRange: string,
	options?: GetApiOptions,
): Promise<T>;

export type TreeNodeCommandCallback<T> = (
	context: IActionContext,
	node?: T,
	nodes?: T[],
	...args: any[]
 ...
 * NOTE: If the environment variable `DEBUGTELEMETRY` is set to a non-empty, non-zero value, then telemetry will not be sent. If the value is 'verbose' or 'v', telemetry will be displayed in the console window.
 */
export declare function registerCommandWithTreeNodeUnwrapping<T>(
	commandId: string,
...
export declare function unwrapTreeNodeCommandCallback<T>(
	treeNodeCallback: TreeNodeCommandCallback<T>,
): TreeNodeCommandCallback<T>;
 ...
 */
export declare function subscriptionExperience(
	context: IActionContext,
	tdp: TreeDataProvider<ResourceGroupsItem>,
 ...
 */
export declare function azureResourceExperience<TPick extends unknown>(
	context: PickExperienceContext,
	tdp: TreeDataProvider<ResourceGroupsItem>,
 ...
 */
export declare function contextValueExperience<TPick extends unknown>(
	context: IActionContext,
	tdp: TreeDataProvider<unknown>,
...
export declare namespace PickTreeItemWithCompatibility {
	 ...
	 */
	export function resource<TPick extends AzExtTreeItem>(
		context: IActionContext,
		tdp: TreeDataProvider<ResourceGroupsItem>,
		options: CompatibilityPickResourceExperienceOptions,
	): Promise<TPick>;
	/**
	 ...
	 */
	export function showTreeItemPicker<TPick extends AzExtTreeItem>(
		context: ITreeItemPickerContext,
		tdp: TreeDataProvider<ResourceGroupsItem>,
		expectedContextValues: string | RegExp | (string | RegExp)[],
		startingTreeItem?: AzExtTreeItem,
...
export declare interface PickSubscriptionWizardContext
	extends QuickPickWizardContext {
	subscription?: AzureSubscription;
}

export declare interface AzureResourceQuickPickWizardContext
	extends QuickPickWizardContext,
		PickSubscriptionWizardContext {
...
export function createCredential(
	getSession: (scopes?: string[]) => ProviderResult<AuthenticationSession>,
...
export declare namespace apiUtils {
	export interface AzureExtensionApiProvider {
		 ...
		 */
		getApi<T extends AzureExtensionApi>(
			apiVersionRange: string,
			options?: GetApiOptions,
		): T;
	}
	 ...
	 * @throws Error if extension with id is not installed.
	 */
	export function getAzureExtensionApi<T extends AzureExtensionApi>(
		context: ExtensionContext,
		extensionId: string,
		apiVersionRange: string,
		options?: GetApiOptions,
	 ...
	 */
	export function getExtensionExports<T>(
		extensionId: string,
	): Promise<T | undefined>;
}
...
export declare interface SkipIfOneQuickPickOptions
	extends GenericQuickPickOptions {
	skipIfOne?: true;
}

export declare interface AzureSubscriptionQuickPickOptions
	extends GenericQuickPickOptions {
	selectBySubscriptionId?: string;
}

export declare abstract class GenericQuickPickStep<
	TContext extends QuickPickWizardContext,
	TOptions extends GenericQuickPickOptions,
> extends AzureWizardPromptStep<TContext> {
	constructor(
...
export declare abstract class GenericQuickPickStepWithCommands<
	TContext extends QuickPickWizardContext,
	TOptions extends GenericQuickPickOptions,
...
export declare interface ContextValueFilterQuickPickOptions
	extends GenericQuickPickOptions {
	contextValueFilter: ContextValueFilter;
}
 ...
 */
export declare class ContextValueQuickPickStep<
	TContext extends QuickPickWizardContext,
	TOptions extends ContextValueFilterQuickPickOptions,
> extends GenericQuickPickStep<TContext, TOptions> {
 ...
 */
export declare class RecursiveQuickPickStep<
	TContext extends QuickPickWizardContext,
 ...
 */
export declare class QuickPickAzureSubscriptionStep extends GenericQuickPickStepWithCommands<
	AzureResourceQuickPickWizardContext,
	SkipIfOneQuickPickOptions
> {
	public constructor(
		tdp: TreeDataProvider<ResourceGroupsItem>,
		options?: GenericQuickPickOptions,
	);
}

export declare interface GroupQuickPickOptions
	extends SkipIfOneQuickPickOptions {
 ...
 */
export declare class QuickPickGroupStep extends GenericQuickPickStep<
	AzureResourceQuickPickWizardContext,
...
export declare interface AzureResourceQuickPickOptions
	extends GenericQuickPickOptions {
 ...
 */
export declare class QuickPickAzureResourceStep extends GenericQuickPickStep<
	AzureResourceQuickPickWizardContext,
	AzureResourceQuickPickOptions
> {
	public constructor(
		tdp: TreeDataProvider<ResourceGroupsItem>,
		options?: AzureResourceQuickPickOptions,
		promptOptions?: IAzureQuickPickOptions,
	);
}
 ...
 */
export declare function runQuickPickWizard<TPick>(
	context: PickExperienceContext,
	wizardOptions?: IWizardOptions<AzureResourceQuickPickWizardContext>,
 ...
 */
export declare function createGenericElement(
 ...
 */
export declare class TreeElementStateManager<
	TElement extends TreeElementWithId = TreeElementWithId,
> implements Disposable
{
	 ...
	 */
	runWithTemporaryDescription<T = void>(
		id: string,
		description: string,
		callback: () => Promise<T>,
...
export declare namespace validationUtils {
	 ...
	 */
	export function hasValidCharLength(
		value: string,
	 ...
	 */
	export function getInvalidCharLengthMessage(
		constraints?: RangeConstraints,
	): string;
}
...
export type AgentQuickPickOptions<
	T extends IAzureQuickPickOptions = IAzureQuickPickOptions,
> = { agentMetadata: ParameterAgentMetadata } & T;

export type AgentInputBoxOptions<
	T extends AzExtInputBoxOptions = AzExtInputBoxOptions,
> = {
...
export interface IAzureAgentInput {
	readonly onDidFinishPrompt: Event<PromptResult>;
	showQuickPick<
		ItemsBaseT extends QuickPickItem,
		OptionsBaseT extends IAzureQuickPickOptions,
	>(
		items:
			| AgentQuickPickItem<ItemsBaseT>[]
			| Promise<AgentQuickPickItem<ItemsBaseT>[]>,
		options: AgentQuickPickOptions<OptionsBaseT> & { canPickMany: true },
	): Promise<AgentQuickPickItem<ItemsBaseT>[]>;
	showQuickPick<
		ItemsBaseT extends QuickPickItem,
		OptionsBaseT extends IAzureQuickPickOptions,
	>(
		items:
			| AgentQuickPickItem<ItemsBaseT>[]
			| Promise<AgentQuickPickItem<ItemsBaseT>[]>,
		options: AgentQuickPickOptions<OptionsBaseT>,
	): Promise<AgentQuickPickItem<ItemsBaseT>>;
	showInputBox<OptionsBaseT extends IAzureQuickPickOptions>(
		options: AgentInputBoxOptions<OptionsBaseT>,
	): Promise<string>;
