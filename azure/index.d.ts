 ...
 */
export declare abstract class AzureAccountTreeItemBase
	...
	implements Disposable
{
	 ...
	 */
	public abstract createSubscriptionTreeItem(
		root: ISubscriptionContext,
	): SubscriptionTreeItemBase | Promise<SubscriptionTreeItemBase>;
	//#endregion
	 ...
	 */
	public getSubscriptionPromptStep(
		wizardContext: Partial<ISubscriptionActionContext>,
 ...
 */
export declare function openInPortal(
...
export declare class LocationListStep<
	T extends ILocationWizardContext,
> extends AzureWizardPromptStep<T> {
	 ...
	 */
	public static addStep<T extends ILocationWizardContext>(
		wizardContext: IActionContext & Partial<ILocationWizardContext>,
	 ...
	 */
	public static setLocation<T extends ILocationWizardContext>(
		wizardContext: T,
		name: string,
	): Promise<void>;
	 ...
	 */
	public static setLocationSubset<T extends ILocationWizardContext>(
		wizardContext: T,
		task: Promise<string[]>,
		provider: string,
	): void;
	 ...
	 */
	public static addProviderForFiltering<T extends ILocationWizardContext>(
		wizardContext: T,
		provider: string,
		resourceType: string,
	): void;
	 ...
	 */
	public static getLocation<T extends ILocationWizardContext>(
		wizardContext: T,
		provider?: string,
		supportsExtendedLocations?: boolean,
	): Promise<AzExtLocation>;

	/**
	 * Returns true if a location has been set on the context
	 */
	public static hasLocation<T extends ILocationWizardContext>(
		wizardContext: T,
	): boolean;
	 ...
	 * @param wizardContext The context of the wizard.
	 */
	public static getLocations<T extends ILocationWizardContext>(
		wizardContext: T,
	): Promise<AzExtLocation[]>;
	 ...
	 */
	public static locationMatchesName(
 ...
 */
export declare class VerifyProvidersStep<
...
export interface IResourceGroupWizardContext
...
export declare class ResourceGroupListStep<
...
> extends AzureWizardPromptStep<T> {
	 ...
	 * @param wizardContext The context of the wizard.
	 */
	public static getResourceGroups<T extends IResourceGroupWizardContext>(
		wizardContext: T,
	 ...
	 * @param wizardContext The context of the wizard.
	 */
	public static isNameAvailable<T extends IResourceGroupWizardContext>(
		wizardContext: T,
		name: string,
	): Promise<boolean>;
...
export declare class ResourceGroupNameStep<
	T extends IResourceGroupWizardContext,
> extends AzureWizardPromptStep<T> {
	public prompt(wizardContext: T): Promise<void>;
	public shouldPrompt(wizardContext: T): boolean;
...
export declare class ResourceGroupCreateStep<
	T extends IResourceGroupWizardContext,
> extends AzureWizardExecuteStep<T> {
	/**
	 * 100
...
export interface IStorageAccountWizardContext
...
> extends AzureWizardPromptStep<T> {
	 ...
	 */
	public constructor(
		createOptions: INewStorageAccountDefaults,
		filterOptions?: IStorageAccountFilters,
	);

	public static isNameAvailable<T extends IStorageAccountWizardContext>(
		wizardContext: T,
		name: string,
	): Promise<boolean>;
...
export declare class StorageAccountNameStep<
	T extends IStorageAccountWizardContext,
...
export declare class StorageAccountCreateStep<
	T extends IStorageAccountWizardContext,
> extends AzureWizardExecuteStep<T> {
	/**
	 * 130
...
export declare class UserAssignedIdentityListStep<
	T extends IResourceGroupWizardContext,
> extends AzureWizardPromptStep<T> {
...
export declare class UserAssignedIdentityCreateStep<
	T extends IResourceGroupWizardContext,
> extends AzureWizardExecuteStep<T> {
	/**
	 * 140
...
export declare class RoleAssignmentExecuteStep<
	T extends IResourceGroupWizardContext,
 ...
 */
export declare function registerAzureUtilsExtensionVariables(
	extVars: IAzureUtilsExtensionVariables,
): void;
 ...
 */
export declare function createGenericClient(
	context: IActionContext,
 ...
 * @param clientInfo The client/credentials info or `undefined` if no credentials are needed
 */
export declare function sendRequestWithTimeout(
	context: IActionContext,
	options: AzExtRequestPrepareOptions,
	timeout: number,
	clientInfo: AzExtGenericClientInfo,
): Promise<AzExtPipelineResponse>;

export type AzExtClientType<T extends ServiceClient> = new (
 ...
 */
export type AzExtClientContext =
	| ISubscriptionActionContext
	| [IActionContext, ISubscriptionContext | AzExtTreeItem];

/**
 * Converts `AzExtClientContext` into a single object: `ISubscriptionActionContext`
 */
export declare function parseClientContext(
 ...
 */
export declare function createAzureClient<T extends ServiceClient>(
	context: AzExtClientContext,
	clientType: AzExtClientType<T>,
): T;

export type AzExtSubscriptionClientType<T> = new (
	credentials: AzExtServiceClientCredentials,
	options?: ServiceClientOptions,
) => T;
 ...
 * 2. Uses resourceManagerEndpointUrl to support sovereigns
 */
export declare function createAzureSubscriptionClient<T>(
	context: AzExtClientContext,
	clientType: AzExtSubscriptionClientType<T>,
): T;

export declare namespace uiUtils {
	export function listAllIterator<T>(
 ...
 */
export function setupAzureLogger(
 ...
 */
export function addBasicAuthenticationCredentialsToClient(
