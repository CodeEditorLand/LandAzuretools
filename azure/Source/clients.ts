...
import {
	...
	InternalAzExtClientContext,
	parseClientContext,
} from "./createAzureClient";

// Lazy-load @azure packages to improve startup performance.
// NOTE: The client is the only import that matters, the rest of the types disappear when compiled to JavaScript

export async function createStorageClient(
	context: InternalAzExtClientContext,
...
export async function createResourcesClient(
	context: InternalAzExtClientContext,
...
export async function createManagedServiceIdentityClient(
	context: InternalAzExtClientContext,
): Promise<ManagedServiceIdentityClient> {
	return createAzureClient(
		context,
		(await import("@azure/arm-msi")).ManagedServiceIdentityClient,
	);
}
