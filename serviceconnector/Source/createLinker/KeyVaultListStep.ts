...
export class KeyVaultListStep extends AzureWizardPromptStep<ICreateLinkerContext> {
	...
	private getPicks(
		accounts: KeyVaultAccountJsonResponse[],
	): IAzureQuickPickItem<KeyVaultAccountJsonResponse>[] {
...
async function getKeyVaultAccounts(
	...
	)).parsedBody as KeyVaultJsonResponse;
}
