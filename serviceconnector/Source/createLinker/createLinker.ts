...
export async function createLinker(
	...
	preSteps: AzureWizardPromptStep<ICreateLinkerContext>[] = [],
	...
	const wizard: AzureWizard<ICreateLinkerContext> = new AzureWizard(
		wizardContext,
		{
...
export function isAzureSubscription(
	subscription: ISubscriptionContext | AzureSubscription,
): subscription is AzureSubscription {
