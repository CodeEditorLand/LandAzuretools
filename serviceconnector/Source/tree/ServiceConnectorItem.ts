...
export function createServiceConnectorItem(
	subscription: ISubscriptionContext,
	item: LinkerItem,
	linker: LinkerResource
	...
	return {
		...
		getTreeItem: (): TreeItem => ({
			...
			label: linker.name,
			iconPath:
				connectionIconPath(linker) === ""
					? new ThemeIcon("dash")
					: getIconPath(connectionIconPath(linker)),
...
function isAzureResource(
	targetResource: TargetServiceBaseUnion
): targetResource is AzureResource {
