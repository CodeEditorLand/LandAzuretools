...
class UninitializedExtensionVariables implements UIExtensionVariables {
	private _error: Error = new Error(
		l10n.t(
			'"registerServiceConnectorExtensionVariables" must be called before using the vscode-azext-serviceconnector package.',
		),
	);
