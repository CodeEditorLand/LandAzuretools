...
import {
	excludeNodeModulesAndDependencies,
	getExternalsEntries,
	getNodeModuleCopyEntries,
	getNodeModulesDependencyClosure,
	PackageLock,
} from "../src/webpack/excludeNodeModulesAndDependencies";
...
const packageLockJson: PackageLock = {
	...
	"dependencies": {
		...
		"@types/node": {
			"version": "10.12.18",
			"resolved":
				"https://registry.npmjs.org/@types/node/-/node-10.12.18.tgz",
			"integrity":
		...
		"deep-assign": {
			"version": "1.0.0",
			"resolved":
				"https://registry.npmjs.org/deep-assign/-/deep-assign-1.0.0.tgz",
		...
		"gulp-chmod": {
			"version": "2.0.0",
			"resolved":
				"https://registry.npmjs.org/gulp-chmod/-/gulp-chmod-2.0.0.tgz",
		...
		"gulp-gunzip": {
			"version": "1.0.0",
			"resolved":
				"https://registry.npmjs.org/gulp-gunzip/-/gulp-gunzip-1.0.0.tgz",
		...
		"gulp-remote-src-vscode": {
			"version": "0.5.1",
			"resolved":
				"https://registry.npmjs.org/gulp-remote-src-vscode/-/gulp-remote-src-vscode-0.5.1.tgz",
			"integrity":
				"sha512-mw4OGjtC/jlCWJFhbcAlel4YPvccChlpsl3JceNiB/DLJi24/UPxXt53/N26lgI3dknEqd4ErfdHrO8sJ5bATQ==",
			"dev": true,
			"requires": {
				"event-stream": "3.3.4",
				"node.extend": "^1.1.2",
		...
		"js-yaml": {
			"version": "3.12.1",
			"resolved":
				"https://registry.npmjs.org/js-yaml/-/js-yaml-3.12.1.tgz",
			"integrity":
		...
		"mocha-junit-reporter": {
			"version": "1.18.0",
			"resolved":
				"https://registry.npmjs.org/mocha-junit-reporter/-/mocha-junit-reporter-1.18.0.tgz",
			"integrity":
		...
		"node.extend": {
			"version": "1.1.8",
			"resolved":
				"https://registry.npmjs.org/node.extend/-/node.extend-1.1.8.tgz",
			"integrity":
				"sha512-L/dvEBwyg3UowwqOUTyDsGBU6kjBQOpOhshio9V3i3BMPv5YUb9+mWNN8MK0IbWqT0AqaTSONZf0aTuMMahWgA==",
			"dev": true,
			"requires": {
				"has": "^1.0.3",
				"is": "^3.2.1",
		...
		"now-and-later": {
			"version": "2.0.0",
			"resolved":
				"https://registry.npmjs.org/now-and-later/-/now-and-later-2.0.0.tgz",
		...
		"querystringify": {
			"version": "2.1.0",
			"resolved":
				"https://registry.npmjs.org/querystringify/-/querystringify-2.1.0.tgz",
			"integrity":
		...
		"resolve": {
			"version": "1.9.0",
			"resolved":
				"https://registry.npmjs.org/resolve/-/resolve-1.9.0.tgz",
			"integrity":
		...
		"source-map-support": {
			"version": "0.5.10",
			"resolved":
				"https://registry.npmjs.org/source-map-support/-/source-map-support-0.5.10.tgz",
			"integrity":
		...
		"streamfilter": {
			"version": "1.0.7",
			"resolved":
				"https://registry.npmjs.org/streamfilter/-/streamfilter-1.0.7.tgz",
			"integrity":
		...
		"supports-color": {
			"version": "1.2.0",
			"resolved":
				"https://registry.npmjs.org/supports-color/-/supports-color-1.2.0.tgz",
		...
		"to-iso-string": {
			"version": "0.0.2",
			"resolved":
				"https://registry.npmjs.org/to-iso-string/-/to-iso-string-0.0.2.tgz",
		...
		"tslint": {
			...
			"integrity":
				"sha512-sfodBHOucFg6egff8d1BvuofoOQ/nOeYNfbp7LDlKBcLNrL3lmS5zoiDGyOMdT7YsEXAwWpTdAHwOGOc8eRZAw==",
			"dev": true,
			"requires": {
		...
		"tslint-microsoft-contrib": {
			"version": "5.0.1",
			"resolved":
				"https://registry.npmjs.org/tslint-microsoft-contrib/-/tslint-microsoft-contrib-5.0.1.tgz",
			...
			"dependencies": {
				"tsutils": {
					"version": "1.9.1",
					"resolved":
						"https://registry.npmjs.org/tsutils/-/tsutils-1.9.1.tgz",
		...
		"url-parse": {
			"version": "1.4.4",
			"resolved":
				"https://registry.npmjs.org/url-parse/-/url-parse-1.4.4.tgz",
			"integrity":
		...
		"vscode": {
			...
			"integrity":
				"sha512-z1Nf5J38gjUFbuDCbJHPN6OJ//5EG+e/yHlh6ERxj/U9B2Qc3aiHaFr38/fee/GGnxvRw/XegLMOG+UJwKi/Qg==",
			"dev": true,
			"requires": {
				"glob": "^7.1.2",
				"gulp-chmod": "^2.0.0",
			...
			"dependencies": {
				...
				"mocha": {
					"version": "4.1.0",
					"resolved":
						"https://registry.npmjs.org/mocha/-/mocha-4.1.0.tgz",
					"integrity":
...
suite("getNodeModulesDependencyClosure", () => {
	test("Empty", () => {
		...
		assert.deepStrictEqual(closure, []);
	});
	...
	test("No deps", () => {
		...
		assert.deepStrictEqual(closure, ["xtend"]);
	});
	...
	test("Pick up nested dependencies", () => {
		...
		const closure = getNodeModulesDependencyClosure(deepPackageLock, [
			"engine.io",
		]);
		assert.deepStrictEqual(closure, ["engine.io", "options"]);
	});
});
		...
		assert.deepStrictEqual(entries, [
			{
				source:
					os.platform() === "win32"
						? "\\root\\node_modules\\abc"
						: "/root/node_modules/abc",
				destination:
					os.platform() === "win32"
						? "\\root\\dist\\node_modules\\abc"
						: "/root/dist/node_modules/abc",
			},
			{
				source:
					os.platform() === "win32"
						? "\\root\\node_modules\\def-ghi"
						: "/root/node_modules/def-ghi",
				destination:
					os.platform() === "win32"
						? "\\root\\dist\\node_modules\\def-ghi"
						: "/root/dist/node_modules/def-ghi",
			},
		]);
	});
});
...
suite("excludeNodeModulesAndDependencies", () => {
	test("config empty", () => {
		...
		excludeNodeModulesAndDependencies("/root", config, packageLockJson, [
			"yauzl",
		]);

		assert.deepStrictEqual(config.externals, {
