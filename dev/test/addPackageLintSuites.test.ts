...
const packageJson: {} = {
	...
	"homepage":
		"https://github.com/Microsoft/vscode-azurestorage/blob/main/README.md",
	"license": "SEE LICENSE IN LICENSE.md",
	"categories": ["Azure"],
	"keywords": ["Azure", "Blob Containers", "File Share", "Storage Account"],
	"preview": true,
	"activationEvents": [
		"onView:azureStorage",
