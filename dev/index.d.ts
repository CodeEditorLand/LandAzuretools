...
export declare function getDefaultWebpackConfig(
 ...
 */
export declare function gulp_installVSCodeExtension(
	publisherId: string,
 ...
 */
export declare function runWithTestActionContext(
	callbackId: string,
 ...
 */
export declare function runWithInputs<T>(
	callbackId: string,
